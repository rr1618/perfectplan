...
const MediaPolicy =(props)=>
{
    ...
    return (
       ...
       <Col>
           <NavBar/>
            <Col className={'policy'} style={{padding:120,paddingTop:80,backgroundImage: "url("+`${PolicyBack}`+")",  backgroundSize: '100% 60%',backgroundRepeat: 'no-repeat'}}>
            <Row justify={'center'}>
